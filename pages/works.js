  ...
  return (
    <Layout>
      ...
      <section className={utilStyles.headingMd}>
        ...
        >
          <ImageSection project={imageSources.doubleMoon} imgW="752" imgH="486" />
        </Box>
        ...
        >
          <ImageSection project={imageSources.posters} imgW="1600" imgH="2000" />
        </Box>
        ...
        >
          <ImageSection project={imageSources.booklets} imgW="825" imgH="1275" />
        </Box>
